...
namespace Aviad
{
    [CustomEditor(typeof(Clusters))]
    public class ClustersEditor : ManagerEditorBase
    {
        ...
        private void AddContributorWithEmbedding(string clusterTag, string input)
        {
            ...
            ModelInstanceManager.Instance.ComputeEmbeddings(EditorLifecycle.Runtime.ModelId, input, new LlamaEmbeddingParams(), embedding =>
            {
                if (embedding != null)
                {
