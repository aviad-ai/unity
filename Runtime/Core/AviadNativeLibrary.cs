...
namespace Aviad
{
    public class AviadNativeLibrary : IAviadGeneration
    {
        ...
        private delegate bool SetLogCallbackDelegate(
            AviadCallbacks.LogCallbackWithLevelDelegate callback);
        ...
        public bool SafeEnsureLoaded()
        {
            ...
            {
                AviadLogger.Error($"AviadGenerationLoadedLibrary.EnsureLoaded failed: {ex.Message}");
                FreeLibrary();
                return false;
            }
        }
        ...
        public void EnsureLoaded()
        {
            ...
            foreach (var depPath in dependencyPaths)
            {
                ...
                {
                    AviadLogger.Warning("[Aviad] Skipping empty dependency path");
                    continue;
                }
                ...
                AviadLogger.Debug($"[Aviad] Loaded dependency: {Path.GetFileName(depPath)}");
            }
            ...
            AviadLogger.Debug($"[Aviad] Loaded main library: {Path.GetFileName(mainLibraryPath)}");
        ...
        public void FreeLibrary()
        {
            ...
            AviadLogger.Debug("[AviadGenerationLoadedLibrary] Native library released");
        }
        ...
        public void Dispose()
        {
            ...
            foreach (var modelId in modelIds)
            {
                ...
                {
                    AviadLogger.DebugFormat("[AviadGenerationLoadedLibrary] Model {0} shutdown. Success: {1}", modelId, success);

                    remainingModels--;
                    if (remainingModels == 0)
                    {
                        AviadLogger.Debug("[AviadGenerationLoadedLibrary] All models shutdown, freeing library");
                        FreeLibrary();
                    }
                });
            }
        ...
        private static readonly AviadCallbacks.LogCallbackWithLevelDelegate DefaultLogCallback = (level, message) =>
        {
            ...
            {
                case 0: // Info
                    AviadLogger.Debug($"[Aviad] {message}");
                    break;
                case 1: // Warning
                    AviadLogger.Warning($"[Aviad] {message}");
                    break;
                case 2: // Error
                    AviadLogger.Warning($"[Aviad] {message}");
                    break;
                default:
                    AviadLogger.Debug($"[Aviad Level {level}] {message}");
                    break;
            }
        };
        ...
        public void SetLoggingEnabled(Action<bool> onDone = null)
        {
            ...
            {
                AviadLogger.Error($"AviadGenerationLoadedLibrary.SetLoggingEnabled failed: {ex.Message}");
            }
            ...
            Action<bool> onDone = null)
        {
            ...
            try
            {
                AviadLogger.Debug($"AviadGenerationLoadedLibrary.InitializeModel modelId: {modelId}");

                var nativeParams = modelParams.ToStruct();
                AviadLogger.Debug(modelParams.modelPath);
            ...
            {
                AviadLogger.Error($"AviadGenerationLoadedLibrary.InitializeModel failed: {ex.Message}");
            }
            onDone?.Invoke(result);
        }
            ...
            Action<bool> onDone = null)
        {
            ...
            {
                AviadLogger.Error($"AviadGenerationLoadedLibrary.ShutdownModel failed: {ex.Message}");
            }
            onDone?.Invoke(result);
        }
            ...
            Action<bool> onDone = null)
        {
            ...
            {
                AviadLogger.Error($"AviadGenerationLoadedLibrary.LoadContext failed: {ex.Message}");
            }
            onDone?.Invoke(result);
        }
            ...
            Action<bool> onDone = null)
        {
            ...
            {
                AviadLogger.Error($"AviadGenerationLoadedLibrary.UnloadActiveContext failed: {ex.Message}");
            }
            onDone?.Invoke(result);
        }
            ...
            Action<bool> onDone = null)
        {
            ...
            {
                AviadLogger.Error($"AviadGenerationLoadedLibrary.CacheContext failed: {ex.Message}");
            }
            onDone?.Invoke(result);
        }
            ...
            Action<LlamaMessageSequence> onResult)
        {
            ...
            {
                AviadLogger.Error($"AviadGenerationLoadedLibrary.GetContext failed: {ex.Message}");
                onResult.Invoke(null);
            }
        }
            ...
            Action<bool> onDone = null)
        {
            ...
            {
                AviadLogger.Error($"AviadGenerationLoadedLibrary.InitContext failed: {ex.Message}");
            }
            onDone?.Invoke(result);
        }
            ...
            Action<bool> onDone = null)
        {
            ...
            {
                AviadLogger.Error($"AviadGenerationLoadedLibrary.AddTurnToContext failed: {ex.Message}");
            }
            onDone?.Invoke(result);
        }
            ...
            Action<bool> onDone = null)
        {
            ...
            {
                AviadLogger.Error($"AviadGenerationLoadedLibrary.AppendToContext failed: {ex.Message}");
            }
            onDone?.Invoke(result);
        }
            ...
            Action<bool> onDone = null)
        {
            ...
            {
                AviadLogger.Error($"AviadGenerationLoadedLibrary.CopyContext failed: {ex.Message}");
            }
            onDone?.Invoke(result);
        }
            ...
            Action<bool> onDone = null)
        {
            ...
            {
                AviadLogger.Error($"AviadGenerationLoadedLibrary.FreeContext failed: {ex.Message}");
            }
            onDone?.Invoke(result);
        }
        ...
        public void GenerateResponse(
            ...
            Action<bool> onDone)
        {
            AviadLogger.Verbose($"AviadGenerationLoadedLibrary.GenerateResponse called.");
            if (!SafeEnsureLoaded())
            {
                onDone?.Invoke(false);
                return;
            ...
            try
            {
                using (var wrapper = config.ToNative())
                {
                    ...
                    AviadCallbacks.TokenStreamCallback onTokenCallback =
                        AviadCallbacks.TokenStreamCallbackFromAction(onToken);
                    AviadCallbacks.StreamDoneCallback onDoneCallback =
                        AviadCallbacks.StreamDoneCallbackFromAction(onDone);
                    generateResponse(
            ...
            {
                AviadLogger.Error($"AviadGenerationLoadedLibrary.GenerateResponse failed: {ex.Message}");
            ...
            Action<bool> onDone = null)
        {
            ...
            {
                AviadLogger.Error($"AviadGenerationLoadedLibrary.AbortInitializeModel failed: {ex.Message}");
            }
            onDone?.Invoke(result);
        }
            ...
            Action<bool> onDone = null)
        {
            ...
            {
                AviadLogger.Error($"AviadGenerationLoadedLibrary.AbortGeneration failed: {ex.Message}");
            }
            onDone?.Invoke(result);
        }
            ...
            Action<float[]> onResult)
        {
            if (!SafeEnsureLoaded())
            {
                AviadLogger.Warning("ComputeEmbeddings: Library not loaded.");
                onResult.Invoke(null);
                return;
            }
            ...
            try
            {
                ...
                if (!success)
                {
                    AviadLogger.Warning("ComputeEmbeddings: Native call returned false.");
                    onResult.Invoke(null);
                    return;
                }
                ...
                for (int i = 0; i < resultArray.Length; i++)
                {
                    ...
                    {
                        AviadLogger.Warning("ComputeEmbeddings: NaN detected in result array.");
                        onResult?.Invoke(null);
                        return;
                    }
                }
            ...
            {
                AviadLogger.Error($"ComputeEmbeddings failed: {ex.Message}");
                onResult.Invoke(null);
            }
            finally
            {
        ...
        public uint GetEmbeddingsSize(string modelId)
        {
            ...
            {
                AviadLogger.Error($"GetEmbeddingsSize failed: {ex.Message}");
                return 0;
            }
        }
    }
